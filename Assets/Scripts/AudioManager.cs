...
public class AudioManager : Singleton<AudioManager>
{
    ...
    protected override void Awake()
    {
        ...
        {
            _musicSource = gameObject.AddComponent<AudioSource>(); //Agregar objetos en caliente
    ...
    public void PlayMusic(string name)
    {
        ...
        if (music != null)
        {
            _musicSource.loop = true;  //Reproduce en bucle
    ...
    public void PlaySFX(string name, bool loop = true)
    {
        ...
        if (sfx != null)
        {
            if (!loop)
            {
                _sfxSource.PlayOneShot(sfx.sound);  //Reproduce una vez
            }
            else
            {
